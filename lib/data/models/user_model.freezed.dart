...
mixin _$UserModel {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.ownedItemIds, ownedItemIds) &&
  ...
  int get hashCode => Object.hash(
      ...
      displayName,
      currency,
      const DeepCollectionEquality().hash(ownedItemIds),
      currentGroupId,
      lastCheckInDate);
...
extension UserModelPatterns on UserModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UserModel() when $default != null:
        return $default(_that.uid, _that.displayName, _that.currency,
            _that.ownedItemIds, _that.currentGroupId, _that.lastCheckInDate);
      case _:
        return orElse();
    }
  }
...
class _UserModel implements UserModel {
  const _UserModel(
      ...
      this.currency = 0,
      final List<String> ownedItemIds = const [],
      this.currentGroupId,
