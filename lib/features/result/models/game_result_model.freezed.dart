...
mixin _$PlayerResultModel {
  ...
  $PlayerResultModelCopyWith<PlayerResultModel> get copyWith =>
      _$PlayerResultModelCopyWithImpl<PlayerResultModel>(
          this as PlayerResultModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PlayerResultModel &&
            (identical(other.uid, uid) || other.uid == uid) &&
            (identical(other.displayName, displayName) ||
                other.displayName == displayName) &&
            (identical(other.explodeCount, explodeCount) ||
                other.explodeCount == explodeCount) &&
            (identical(other.passCount, passCount) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, displayName, explodeCount, passCount);
...
abstract mixin class $PlayerResultModelCopyWith<$Res> {
  factory $PlayerResultModelCopyWith(
          PlayerResultModel value, $Res Function(PlayerResultModel) _then) =
      _$PlayerResultModelCopyWithImpl;
  @useResult
  $Res call({String uid, String displayName, int explodeCount, int passCount});
}
...
class _$PlayerResultModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? explodeCount = null,
    Object? passCount = null,
  }) {
    return _then(_self.copyWith(
      ...
      displayName: null == displayName
          ...
          : displayName // ignore: cast_nullable_to_non_nullable
              as String,
      explodeCount: null == explodeCount
          ? _self.explodeCount
          : explodeCount // ignore: cast_nullable_to_non_nullable
              as int,
      passCount: null == passCount
          ? _self.passCount
          : passCount // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension PlayerResultModelPatterns on PlayerResultModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlayerResultModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PlayerResultModel() when $default != null:
        return $default(
            _that.uid, _that.displayName, _that.explodeCount, _that.passCount);
      case _:
        return orElse();
    }
  }
...
class _PlayerResultModel implements PlayerResultModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlayerResultModelCopyWith<_PlayerResultModel> get copyWith =>
      __$PlayerResultModelCopyWithImpl<_PlayerResultModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlayerResultModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PlayerResultModelCopyWith<$Res>
    implements $PlayerResultModelCopyWith<$Res> {
  factory _$PlayerResultModelCopyWith(
          _PlayerResultModel value, $Res Function(_PlayerResultModel) _then) =
      __$PlayerResultModelCopyWithImpl;
  @override
  @useResult
  $Res call({String uid, String displayName, int explodeCount, int passCount});
}
...
mixin _$GameResultModel {
  String get groupId;
  List<PlayerResultModel> get rankList; // 폭발 횟수 오름차순 정렬
  ...
  $GameResultModelCopyWith<GameResultModel> get copyWith =>
      _$GameResultModelCopyWithImpl<GameResultModel>(
          this as GameResultModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GameResultModel &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            const DeepCollectionEquality().equals(other.rankList, rankList) &&
  ...
  int get hashCode => Object.hash(runtimeType, groupId,
      const DeepCollectionEquality().hash(rankList), endedAt);
...
abstract mixin class $GameResultModelCopyWith<$Res> {
  factory $GameResultModelCopyWith(
          GameResultModel value, $Res Function(GameResultModel) _then) =
      _$GameResultModelCopyWithImpl;
  @useResult
  $Res call(
    ...
    return _then(_self.copyWith(
      groupId: null == groupId
          ...
          : groupId // ignore: cast_nullable_to_non_nullable
              as String,
      rankList: null == rankList
          ? _self.rankList
          : rankList // ignore: cast_nullable_to_non_nullable
...
extension GameResultModelPatterns on GameResultModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GameResultModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _GameResultModel() when $default != null:
        return $default(_that.groupId, _that.rankList, _that.endedAt);
      case _:
        return orElse();
    }
  }
...
class _GameResultModel implements GameResultModel {
  const _GameResultModel(
      {required this.groupId,
      required final List<PlayerResultModel> rankList,
  ...
  @override
  List<PlayerResultModel> get rankList {
...
// 폭발 횟수 오름차순 정렬
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GameResultModelCopyWith<_GameResultModel> get copyWith =>
      __$GameResultModelCopyWithImpl<_GameResultModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GameResultModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GameResultModel &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            const DeepCollectionEquality().equals(other._rankList, _rankList) &&
            (identical(other.endedAt, endedAt) || other.endedAt == endedAt));
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, groupId,
      const DeepCollectionEquality().hash(_rankList), endedAt);
...
/// @nodoc
abstract mixin class _$GameResultModelCopyWith<$Res>
    implements $GameResultModelCopyWith<$Res> {
  factory _$GameResultModelCopyWith(
          _GameResultModel value, $Res Function(_GameResultModel) _then) =
      __$GameResultModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String groupId, List<PlayerResultModel> rankList, DateTime endedAt});
